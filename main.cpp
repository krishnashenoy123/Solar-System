...
void display(void)
{
    ...
    if(frontpage == true)
    {
        ...
        glColor3f(1, 1, 0);
        glRasterPos2f(-2.9,2.5);
        sprintf(tmp_str,"UNIVERSITY VISVESVARAYA COLLEGE OF ENGINEERING");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-1.4,2.2);
        sprintf(tmp_str,"K R Circle, Bengaluru - 560 001");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-1.5,1.7);
        sprintf(tmp_str,"Computer Graphics Project on: ");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-1.0,1.2);
        sprintf(tmp_str,"SOLAR SYSTEM");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-3.0,0.6);
        sprintf(tmp_str,"Submitted by :-");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-2.5,0.1);
        sprintf(tmp_str,"Krishna Shenoy S");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-2.4,-0.3);
        sprintf(tmp_str,"(19GANSE023)");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(1.5,0.1);
        sprintf(tmp_str,"Kavya Bhat");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(1.3,-0.3);
        sprintf(tmp_str,"(19GANSE021)");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-1,-1.3);
        sprintf(tmp_str,"under the guidance of");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-0.7,-1.5);
        sprintf(tmp_str,"Dr. HS Vimala");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-0.5,-1.7);
        sprintf(tmp_str,"Manjula S");
        print(tmp_str);

        glColor3f(1, 1, 0);
        glRasterPos2f(-0.35,-1.9);
        sprintf(tmp_str,"UVCE");
        print(tmp_str);

         glColor3f(1, 1, 1);
        glRasterPos2f(1,-2.5);
        sprintf(tmp_str,"press ENTER key to continue");
        Write(tmp_str);
    ...
    if(menu == true)
    {
		...
		glColor3f(1, 0,0);
        glRasterPos2f(-1.5,2);
        sprintf(tmp_str,"WELCOME TO SOLAR SYSTEM");
        print(tmp_str);
        ...
        glClearColor(0,0,0,0);
         glColor3f(1, 0.5, 0);
        glRasterPos2f(-0.6,1.09);
        sprintf(tmp_str,"MAIN MENU");
        print(tmp_str);
        ...
        sprintf(tmp_str,"1. Proceed");
        print(tmp_str);

         glClearColor(0,0,0,0);
         glColor3f(0, 0, 1);
        glRasterPos2f(-0.8,0.4);
        sprintf(tmp_str,"2. Instructions");
        print(tmp_str);

         glClearColor(0,0,0,0);
         glColor3f(0,0, 1);
        glRasterPos2f(-0.8,0.1);
        sprintf(tmp_str,"3. Exit");
        print(tmp_str);
    ...
    if(instructions == true)
    {
        ...
        glRasterPos2f(-3.5,1.5);
        sprintf(tmp_str,"1.	The keys m, v, e, r, j, s, u, n are used to rotate the planets.");
        print(tmp_str);

        glRasterPos2f(-3.5,0.8);
        sprintf(tmp_str,"2.	The keys M, V, E, R, J, S, U, N are used to revolve the planets around the Sun.");
        print(tmp_str);

        glRasterPos2f(-3.5,0);
        sprintf(tmp_str,"3.	The key z rotates the sun, B gives both the rotation and revolution of");
        print(tmp_str);

        glRasterPos2f(-3.3,-0.3);
        sprintf(tmp_str,"the planets around the rotating Sun with a Comet revolution and Stars twinkle");
        print(tmp_str);

        glRasterPos2f(-3.5,-1);
        sprintf(tmp_str,"4.	Pressing  the  key A  revolves  all the planets	and comet and the key a rotates all");
        print(tmp_str);

        glRasterPos2f(-3.3,-1.3);
        sprintf(tmp_str,"the planets around the rotating Sun with Stars twinkling in the background.");
        print(tmp_str);

        glRasterPos2f(-3.5,-2);
        sprintf(tmp_str,"5.	The key b is used to make the stars twinkle and c for the revolution of the Comet.");
        print(tmp_str);
    }
    if(execution == true)
    {
